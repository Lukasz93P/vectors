...
class TestVectorsSubtracting(VectorsTestPreparation):
    ...
    def test_two_vectors_subtraction(self):
        self.assertEqual(vector_utils.subtract(self.x_test_vector, self.y_test_vector), self.two_vectors_subtr_result)

    def test_three_vectors_subtraction(self):
        self.assertEqual(vector_utils.subtract(self.x_test_vector, self.y_test_vector, self.z_test_vector),
